...
const { SEARCH_LIST_PER_DIR_MAX, SEARCH_LIST_TOTAL_DIR_MAX } = require("../constants.js");
...
const SEARCH_LIST_HEADER_RE = HEADER_RE;

module.exports = { searchList, SEARCH_LIST_HEADER_RE };
