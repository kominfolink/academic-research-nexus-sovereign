...
const { DETECT_WINDOW, READ_NUMBERED_MIN_HIT_RATIO, SMART_TRUNCATE_MIN_LINES } = require("./constants.js");
...
const { readNumbered, READ_NUMBERED_LINE_RE } = require("./filters/readNumbered.js");
const { searchList, SEARCH_LIST_HEADER_RE } = require("./filters/searchList.js");
