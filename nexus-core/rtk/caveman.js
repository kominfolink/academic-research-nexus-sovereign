...
const { FORMATS } = require("../translator/formats.js");
const { CAVEMAN_PROMPTS } = require("./cavemanPrompts.js");

const SEP = "\n\n";

function injectCaveman(body, format, level) {
