...
const { RAW_CAP, MIN_COMPRESS_SIZE } = require("./constants.js");
const { autoDetectFilter } = require("./autodetect.js");
const { safeApply } = require("./applyFilter.js");
...
module.exports = { compressMessages, formatRtkLog };
